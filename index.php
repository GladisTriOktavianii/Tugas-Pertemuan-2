        ...
        <table border="1" width="1200px" height="700px" align="center">
            ...
            <tr height="50px" style="background-color:dodgerblue;">
                <td align="center" style="word-spacing: 4em;">
                    ...
                    <a href="https://github.com/GladisTriOktavianii" style="text-decoration: none; color: white;"><i>GITHUB</i></a>
                </td>    
            </tr>
            <br>
            <br>
            ...
            <tr height="450px" style="background-color: dodgerblue;;">
                <td valign="top">
                    ...
                    <table align="center" style="margin-top: 40px;">
                        <tr>
                            <th style="color:aliceblue; margin-top: 50px;"><h1>BERANDA</h1></th>
                        </tr>
                        <tr>
                            <td style="text-align: center;"><h3>Silahkan lihat-lihat website tugas saya, dan follow akun atau contact saya</h3></td>
                        </tr>
                    </table>
                </td>    
            </tr>
